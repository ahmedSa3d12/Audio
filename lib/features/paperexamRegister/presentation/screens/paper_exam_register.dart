...
class PaperExmRegisterPage extends StatefulWidget {
  ...
  PaperExmRegisterPage({
    Key? key,
    required this.timeDataModel,
  }) : super(key: key);
...
class _PaperExmRegisterPageState extends State<PaperExmRegisterPage> {
  ...
  void initState() {
    super.initState();
    context.read<PaperExamRegisterCubit>().times =
        widget.timeDataModel.data!.times;
    context.read<PaperExamRegisterCubit>().dropdownValue =
        widget.timeDataModel.data!.times.elementAt(0);
  }
        ...
        body: SafeArea(
            ...
            child: Stack(children: [
              Positioned(
                  ...
                  left: 0,
                  bottom: 0,
                  child: BlocBuilder<PaperExamRegisterCubit,
                      PaperExamRegisterState>(
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Center(
                                        child: MySvgWidget(
                                            path: ImageAssets.userphoneIcon,
                                            imageColor:
                                                AppColors.liveExamGrayTextColor,
                                            size: 20)),
                                    const SizedBox(width: 25),
                                          ...
                                          return DropdownMenuItem<Time>(
                                              ...
                                              child: Container(
                                                  ...
                                                  child: Text(
                                                    "group_time".tr() +
                                                        ":" +
                                                        value.from.replaceRange(
                                                            value.from.length -
                                                                3,
                                                            value.from.length,
                                                            '') +
                                                        " - " +
                                                        value.to.replaceRange(
                                                            value.to.length - 3,
                                                            value.to.length,
                                                            ''),
