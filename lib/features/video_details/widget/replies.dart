...
class Replies extends StatefulWidget {
  Replies({Key? key, required this.loginModel}) : super(key: key);
                          ...
                          child: cubit.commentsModel!.replies.isNotEmpty
                              ? Padding(
                                  ...
                                  child: ListView.builder(
                                    shrinkWrap: true,
                                    itemCount:
                                        cubit.commentsModel!.replies.length,
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                cubit.commentsModel!.replies
                                                            .elementAt(index)
                                                            .user
                                                            .id
                                                            .toString() !=
                                                        widget.loginModel!.data!
                                                            .id
                                                            .toString()
                                                    ? Container()
                                                    : Row(
                              ...
                              : NoDataWidget(
                                  onclick: () {
                                    cubit.getcomments(
                                        cubit.videoModel!.id, "video_resource");
                                  },
                                  title: "no_replies".tr()),
                        ),
                        Positioned(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          cubit.replay_control.text.isNotEmpty
                                              ? cubit.addreplay("text", '', '')
                                              : cubit.isRecording
                                                  ? cubit.stop(2)
                                                  : cubit.start();
                                        },
