...
AllLessonsModel allLessonsModelFromJson(String str) => AllLessonsModel.fromJson(json.decode(str));

String allLessonsModelToJson(AllLessonsModel data) => json.encode(data.toJson());
...
class AllLessonsModel {
  ...
  factory AllLessonsModel.fromJson(Map<String, dynamic> json) => AllLessonsModel(
    id: json["id"],
