class MakeYourExamModel {
  ...
  factory MakeYourExamModel.fromJson(Map<String, dynamic> json) =>
      MakeYourExamModel(
        data: List<MakeYourExamModelData>.from(
            json["data"].map((x) => MakeYourExamModelData.fromJson(x))),
...
class MakeYourExamModelData {
  ...
  factory MakeYourExamModelData.fromJson(Map<String, dynamic> json) =>
      MakeYourExamModelData(
        id: json["id"],
        name: json["name"],
        image: json["image"],
