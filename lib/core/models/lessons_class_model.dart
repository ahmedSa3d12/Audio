...
class LessonsClassModel {
  ...
  factory LessonsClassModel.fromJson(Map<String, dynamic> json) => LessonsClassModel(
    data: json["data"] == null ? null : LessonsClassData.fromJson(json["data"]),
    code: json["code"],
...
class LessonsClassData {
  ...
  factory LessonsClassData.fromJson(Map<String, dynamic> json) => LessonsClassData(
    dataClass: json["class"] == null ? null : AllClasses.fromJson(json["class"]),
    lessons: json["lessons"] == null ? [] : List<AllLessonsModel>.from(json["lessons"]!.map((x) => AllLessonsModel.fromJson(x))),
  );
