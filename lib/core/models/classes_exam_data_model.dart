...
ClassesExamDataModel classesExamDataModelFromJson(String str) =>
    ClassesExamDataModel.fromJson(json.decode(str));

String classesExamDataModelToJson(ClassesExamDataModel data) =>
...
class ClassesExamDataModel {
  ...
  factory ClassesExamDataModel.fromJson(Map<String, dynamic> json) =>
      ClassesExamDataModel(
        data: List<ClassesExamDatumModel>.from(
            json["data"].map((x) => ClassesExamDatumModel.fromJson(x))),
...
class ClassesExamDatumModel {
  ...
  factory ClassesExamDatumModel.fromJson(Map<String, dynamic> json) =>
      ClassesExamDatumModel(
        id: json["id"],
        name: json["name"],
