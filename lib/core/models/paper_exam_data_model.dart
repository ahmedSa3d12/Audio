...
class PaperExam {
  ...
  factory PaperExam.fromJson(Map<String, dynamic> json) => PaperExam(
    ...
    dateExam: json["dateExam"] == null ? null : DateTime.parse(json["dateExam"]),
    time: json["time"]??'',
  ...
  Map<String, dynamic> toJson() => {
    ...
    "dateExam": "${dateExam!.year.toString().padLeft(4, '0')}-${dateExam!.month.toString().padLeft(2, '0')}-${dateExam!.day.toString().padLeft(2, '0')}",
    "time": time,
    "address": address,
    "section": section,
